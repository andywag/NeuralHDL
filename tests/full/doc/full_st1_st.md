...
## Input/Output
* output full_st1_st_data_out      - float_24_8  : Output of the block following the equal to dataIn*taps + bias

* input full_st1_st_data      - float_24_8    : Data Input of the Block
* input taps[191:0] - <u,192,0>      : Neural Tap input of the Block
* input full_st1_st_bias      - float_24_8      : Bias Input of the Block (Needs to be delayed by 1 sample relative to other inputs
...
* [Verilog Output](../design/full_st1_st.v)
