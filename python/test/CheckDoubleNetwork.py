...
base = "/home/andy/projects/NeuralHDL/tests/"
...
def test(args, number, location) :
    full = base + location + "/data/"
    errors = [pu.handleStage(full,x,args.plot) for x in range(number)]
